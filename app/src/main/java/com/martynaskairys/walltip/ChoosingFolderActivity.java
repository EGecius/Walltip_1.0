...
public class ChoosingFolderActivity extends AppCompatActivity {
	...
	private int[] dailyInspirationThumbIds = {R.drawable.a1, R.drawable.a2, R.drawable.a3, R.drawable.a4, R.drawable.a5,
			R.drawable.a6, R.drawable.a7, R.drawable.a8, R.drawable.a9, R.drawable.a10, R.drawable.a11, R.drawable.a12};


	private int[] healthyLifeThumbIds = {
			R.drawable.b1,
			R.drawable.b2,
			R.drawable.b3,
			R.drawable.b4,
	...
	private int[] bePositiveThumbIds = {
			R.drawable.c1,
			R.drawable.c2,
			R.drawable.c3,
			R.drawable.c4,
